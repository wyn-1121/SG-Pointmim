...
def get_args():
    ...
    parser.add_argument('--resume_epoch', type=int, default=-1, help='Epoch to resume from')
    parser.add_argument(
        '--config', 
        type = str, 
    ...
    parser.add_argument('--stage2', action='store_true', default=False, help='Run stage 2 of pretraining (MAE)')
    parser.add_argument(
        '--test', 
        action='store_true', 
        default=False, 
